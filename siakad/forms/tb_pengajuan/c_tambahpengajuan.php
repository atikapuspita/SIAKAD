...
$query = "INSERT INTO tb_pengajuan (`id_pengajuan`, `npm`, `alasan`, `tgl_pengajuan`, `nama_ortu`,`ttd_ortu`) 
         VALUES ('$id_pengajuan', '$npm', '$alasan', '$tgl_pengajuan', '$nama_ortu', '$nama_ttd_ortu')";
