                  ...
                  <tbody>
                    ...
                    <?php foreach ($user as $row) : ?>
                            <tr>
                                ...
                                <td><img src="img/smt1/<?php echo $row['nilai_smt1'];?>"width="100px" height="100px"></td>
                                <td><img src="img/smt2/<?php echo $row['nilai_smt2'];?>"width="100px" height="100px"></td>
                                <td><img src="img/smt3/<?php echo $row['nilai_smt3'];?>"width="100px" height="100px"></td>
                                <td><img src="img/smt4/<?php echo $row['nilai_smt4'];?>"width="100px" height="100px"></td>
                                <td><img src="img/smt5/<?php echo $row['nilai_smt5'];?>"width="100px" height="100px"></td>
                                <td><center>
                                    <a data-toggle ="modal" data-target="#myModal<?php echo $row['nip_npak']; ?>" class ="btn btn-app"><i class="nav-icon fas fa-edit"></i></a>
                                    <a href="hapusnilai.php?id_nilai=<?= $row["id_nilai"]; ?>"class ="btn btn-app"><i class="fas fa-trash-alt"></i></a>                                
                                </td></center>
                            </tr>
                        <?php $i++ ; ?>
